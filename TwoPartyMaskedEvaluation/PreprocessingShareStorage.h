...
namespace TwoPartyMaskedEvaluation
{
	...
	public:
		...
		PreprocessingShareStorage(PreprocessingShare *aliceShare, PreprocessingShare *bobShare, std::vector<uint32_t>&& masks);
		PreprocessingShareStorage(PreprocessingShare *aliceShare, PreprocessingShare *bobShare, std::vector<uint32_t>&& masks, std::vector<int> maskIndex);
	};
}
